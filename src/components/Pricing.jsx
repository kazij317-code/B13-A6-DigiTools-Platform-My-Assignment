    ...
    <div className="py-12 mb-18">
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[30px] px-4 mt-8">
          ...
          <div className="card bg-[#F2F2F2] shadow-xl rounded-3xl border-gray-500 p-6">
          ...
          <div className="card bg-linear-to-r from-[#4F39F6] to-[#9514FA] shadow-xl p-6 text-white rounded-3xl relative">
            ...
            <button className="btn btn-primary rounded-full px-4 py-4 font-bold mt-4 bg-white text-[#9514FA]">Start Pro Trial</button>
          </div>

          <div className="card bg-[#F2F2F2] shadow-xl p-6 rounded-3xl">
